  ...
  return (
    <div className="w-72 bg-card-bg border-r border-border-soft shrink-0 flex flex-col z-10 shadow-sm relative">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <p className="text-xs font-semibold text-text-muted uppercase tracking-wider mb-3 px-1">Question Types</p>
          ...
          {QUESTION_TYPES.map((type) => {
            ...
            return (
              <button
                ...
                className="group flex flex-col items-center justify-center p-4 gap-3 rounded-xl border border-border-soft hover:border-primary hover:bg-purple-light hover:shadow-md transition-all bg-card-bg text-text-primary hover:text-primary relative overflow-hidden cursor-pointer"
              >
                <div className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity">
                   <Plus className="w-3.5 h-3.5 text-primary" />
                </div>
                <div className="w-10 h-10 rounded-full bg-page-bg group-hover:bg-card-bg text-text-secondary group-hover:text-primary flex items-center justify-center transition-colors">
