      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-page-bg/80 backdrop-blur-md border-b border-border-soft/50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-text-secondary">
            ...
            <Link href="#" className="hover:text-text-primary transition-colors">Solutions</Link>
        ...
        <div className="flex-1 w-full max-w-2xl relative">
          ...
          <div className="bg-card-bg rounded-[2rem] shadow-2xl border border-border-soft overflow-hidden aspect-[4/3] flex flex-col relative z-0">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
              ...
              <h2 className="text-3xl font-medium text-text-primary mb-8 leading-tight">
      ...
      <section id="features" className="py-24 bg-card-bg border-y border-border-soft">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-bold text-text-primary mb-6 tracking-tight">Everything you need to build better forms</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-card-elevated border border-border-soft">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Drag & Drop Builder</h3>
            ...
            <div className="p-8 rounded-3xl bg-card-elevated border border-border-soft">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Live Preview</h3>
            ...
            <div className="p-8 rounded-3xl bg-card-elevated border border-border-soft">
              ...
              <h3 className="text-xl font-bold text-text-primary mb-3">Built-in Validation</h3>
