            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  type="checkbox"
                  required
                  className="h-4 w-4 text-primary focus:ring-primary border-border-strong rounded cursor-pointer bg-input-bg"
                />
              </div>
              <div className="ml-2 text-sm">
                <label htmlFor="terms" className="text-text-muted">
                  I agree to the <a href="#" className="font-medium text-primary hover:text-primary-hover">Terms of Service</a> and <a href="#" className="font-medium text-primary hover:text-primary-hover">Privacy Policy</a>
                </label>
              </div>
            </div>
